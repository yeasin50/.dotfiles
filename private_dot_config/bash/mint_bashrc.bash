# This is for LINUX MINT workstation .bashrc 
...
# dynamically source other bash files
SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"

[ -f "$SCRIPT_DIR/env.bash" ] && source "$SCRIPT_DIR/env.bash"
[ -f "$SCRIPT_DIR/aliases.bash" ] && source "$SCRIPT_DIR/aliases.bash"
